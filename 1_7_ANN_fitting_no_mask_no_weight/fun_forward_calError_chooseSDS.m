...
function output=fun_forward_calError_chooseSDS(param_arr)
    ...
    global lambda fitting_wl_tr num_SDS_cw num_SDS_tr SDS_choosed_cw SDS_choosed_tr SDS_sim_correspond_cw SDS_sim_correspond_tr num_gate gate_choosed gate_sim_correspond use_min_disk;  
    ...
    temp_SDS_error=sqrt(mean(temp_SDS_error(gate_choosed,:).^2,1));
