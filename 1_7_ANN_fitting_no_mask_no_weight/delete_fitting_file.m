...
fitting_dir='fitting_SDS123456__gate1-5'; % the fitting folder
...
%             newFolderName = fullfile(input_dir,subject_name_arr{sbj},['target_' num2str(target_i) '_' num2str(error_i)],[fitting_dir '_']);  % 你的新文件夹名
