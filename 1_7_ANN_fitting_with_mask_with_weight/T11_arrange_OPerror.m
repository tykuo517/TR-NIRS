...
%% param
fitting_dir_arr={'test_fitting_2023-11-02-11-10-06'};
fitting_SDS_dir_arr={'fitting_SDS_234','fitting_SDS_234_gate234_weight_0','fitting_SDS_234_gate567_weight_0'};
fitting_dir_index=[1 1 1 1 1];
add_noise_arr=[1 1 1 1 1];
fitting_name_arr={'SDS 234','SDS 234 gate 234','SDS 567 gate 567'}; %'SDS 12 merged no noise',
