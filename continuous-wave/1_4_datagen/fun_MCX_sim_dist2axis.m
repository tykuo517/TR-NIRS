...
assert(size(p_pos,1)==size(detector_r,1)+1,'ERROR: detectornot match with probe setting!')
assert(size(p_pos,1)==size(detector_larger_r,1)+1,'ERROR: detecto_r r_larger_r not match with probe setting!')
